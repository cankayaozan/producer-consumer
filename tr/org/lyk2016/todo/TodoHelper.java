...
public class TodoHelper {
	 ...
	 */
	public static void mark(int index, boolean isDone) throws MyException {
		// TODO you need to implement this method
		if(index+1<=todos.size()){
		todos.get(index).setDone(isDone);
		}
		else{
			System.out.println("size aþýldý dikkatli ol lütfen");
		}
	if(todos.get(index).isDone()==isDone){
	...
	public static Iterator<Todo> getIterator() {
		...
		// throw new UnsupportedOperationException("You need to implement (fill)
		// this method's body.");
