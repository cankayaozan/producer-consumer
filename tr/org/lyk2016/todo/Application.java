...
public class Application {
	...
	private static void processInput(String input) {
		...
		try {
			...
			System.out.println("bir deðer girin, bos bos enter a basmayýn");
			return;
}
		String param = null;
		...
		case 2:
			try {
				...
				// TODO Auto-generated catch block
System.out.println("giris sekliniz yanlýs"+e.getMassage);
return;
		}
			break;
		case 3:
		...
		default:
			...
			System.out.println("bosluk içeren ifade var ");
}
}
